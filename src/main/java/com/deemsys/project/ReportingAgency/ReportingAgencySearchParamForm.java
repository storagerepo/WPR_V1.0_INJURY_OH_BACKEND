...
public class ReportingAgencySearchParamForm {
	...
	public ReportingAgencySearchParamForm(int countyId, String ncicCode, String reportingAgencyName, Integer pageNumber,
	...
	public ReportingAgencySearchParamForm() {
		super();
